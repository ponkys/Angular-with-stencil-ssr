...
function loadHydrateAppScript() {
    if (cachedAppScript == null) {
        ...
        const appCode = fs.readFileSync('/Users/diego.mosquera/Documents/web_repos/angular-stencil-poc/consumer-web-poc/node_modules/@ponkys/consumer-web-components-test/dist/hydrate/app.js', 'utf8');
...
class MockAttr {
    constructor(attrName, attrValue = '', namespaceURL = null) {
...
class MockDocumentTypeNode extends MockElement {
    constructor(ownerDocument) {
...
class MockWindow {
    constructor(html = null) {
        this.URL = URL_;
        this.__clearInterval = clearInterval;
        this.__clearTimeout = clearTimeout;
        this.__setInterval = setInterval;
        this.__setTimeout = setTimeout;
        this.__maxTimeout = 30000;
        this.__allowInterval = true;
        if (html !== false) {
